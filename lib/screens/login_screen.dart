                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        // (Optional) Create account button – keep if you want self-signup
                        // FadeInUp(
                        ...
                        //         foregroundColor: _seed,
                        //         side: BorderSide(color: _seed.withOpacity(0.6)),
                        //         shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(50)),
                        //       ),
                        //       onPressed: loading ? null : () {/* navigate to signup */},
                        //       child: const Text('Créer un compte'),
                        //     ),
                        //   ),
                        // ),
                        const Spacer(),
                        // Small brand footer tint
                        FadeInUp(
